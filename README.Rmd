...
[![Travis build status](https://travis-ci.com/OldLipe/rwlts.svg?branch=master)](https://travis-ci.com/OldLipe/rwlts)
...
[![Codecov test coverage](https://codecov.io/gh/OldLipe/rwlts/branch/master/graph/badge.svg)](https://codecov.io/gh/OldLipe/rwlts?branch=master)
<!-- badges: end -->
